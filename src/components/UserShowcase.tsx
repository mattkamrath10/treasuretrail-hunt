...
const s: Record<string, CSSProperties> = {
  ...
  cardImgLg: { position: 'relative', width: '100%', aspectRatio: '4 / 3', overflow: 'hidden', background: 'var(--tt-image-bg)' },
  cardMd: {
    flex: '0 0 auto',
    width: 150,
    scrollSnapAlign: 'start',
  ...
  cardImgMd: { position: 'relative', width: '100%', aspectRatio: '1 / 1', overflow: 'hidden', background: 'var(--tt-image-bg)' },
  ...
  cardTitle: {
    margin: 0, fontSize: 13, fontWeight: 700, color: 'var(--tt-text)', lineHeight: 1.3,
    display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', overflow: 'hidden',
  },
  cardTitleSm: {
    margin: 0, fontSize: 12, fontWeight: 700, color: 'var(--tt-text)', lineHeight: 1.3,
    display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', overflow: 'hidden',
  },
  cardMeta: { margin: '6px 0 0', fontSize: 11, color: 'var(--tt-text-muted)', lineHeight: 1.3 },
  loading: {
