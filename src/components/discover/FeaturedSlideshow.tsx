...
const s: Record<string, CSSProperties> = {
  ...
  dotActive: { width: 20, background: 'var(--tt-accent)' },
  empty: {
  ...
  emptyTitle: { margin: 0, fontSize: 15, fontWeight: 800, color: 'var(--tt-text)' },
  emptyBody: { margin: '6px 0 0', fontSize: 13, color: 'var(--tt-text-muted)' },
};
